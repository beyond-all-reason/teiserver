...
CREATE USER teiserver_test3 WITH PASSWORD '123456789';
ALTER USER teiserver_test3 WITH SUPERUSER;
CREATE USER teiserver_test4 WITH PASSWORD '123456789';
ALTER USER teiserver_test4 WITH SUPERUSER;
CREATE USER teiserver_test5 WITH PASSWORD '123456789';
ALTER USER teiserver_test5 WITH SUPERUSER;
EOF
exit
