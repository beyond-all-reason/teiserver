defmodule Central.General.FileHelperTest do
  ...
  test "icon_and_colour" do
    values = ["URL", "Plain text", "PDF", "Image", "Rich text", "Spreadsheet", "Presentation", "Audio", "Video", "Code", "type"]
  ...
  test "ext_icon" do
    values = [100, 1_000, 10_000, 100_000, 1_000_000, 10_000_000, 100_000_000]
