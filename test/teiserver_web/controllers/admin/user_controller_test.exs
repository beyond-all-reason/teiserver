defmodule TeiserverWeb.Admin.UserControllerTest do
  ...
  #     conn = get(conn, Routes.ts_admin_user_path(conn, :reset_password, user))
  ...
  #     resp = get(conn, Routes.ts_admin_user_path(conn, :edit, user2))
  #     assert resp.private[:phoenix_flash]["danger"] == "Unable to find that user"
  #     assert redirected_to(resp) == Routes.ts_admin_user_path(conn, :index)
  #   end
  # end
  ...
  #     resp = get(conn, Routes.ts_admin_user_path(conn, :edit_permissions, user))
  ...
  #     resp = get(conn, Routes.ts_admin_user_path(conn, :edit_permissions, -1))
  ...
  #     resp = get(conn, Routes.ts_admin_user_path(conn, :edit_permissions, user2))
  ...
  #     resp =
  #       post(conn, Routes.ts_admin_user_path(conn, :update_permissions, user),
  #         permissions: %{
  #           "\"admin.user\"" => [
  #             "admin.user.show",
  #             "admin.user.create",
  ...
  #     assert redirected_to(resp) == Routes.ts_admin_user_path(resp, :show, user) <> "#permissions"
  #   end
  ...
  #     resp =
  #       post(conn, Routes.ts_admin_user_path(conn, :update_permissions, target_user),
  ...
  #              Routes.ts_admin_user_path(resp, :show, target_user) <> "#permissions"
  #   end
  ...
  #     resp = post(conn, Routes.ts_admin_user_path(conn, :update_permissions, user))
  ...
  #     resp = post(conn, Routes.ts_admin_user_path(conn, :update_permissions, -1), permissions: %{})
  ...
  #     resp =
  #       post(conn, Routes.ts_admin_user_path(conn, :update_permissions, user2), permissions: %{})
