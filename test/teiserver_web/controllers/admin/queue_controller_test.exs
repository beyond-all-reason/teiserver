defmodule BarserverWeb.Game.QueueControllerTest do
  ...
  describe "index" do
    test "lists all queues", %{conn: conn} do
      BarserverTestLib.make_queue("admin_index_queue1")
      BarserverTestLib.make_queue("admin_index_queue2")
  ...
  describe "show queue" do
    test "renders show page", %{conn: conn} do
      queue = BarserverTestLib.make_queue("admin_show")
  ...
  describe "edit queue" do
    ...
    test "renders form for editing chosen queue", %{conn: conn} do
      queue = BarserverTestLib.make_queue("admin_edit_form")
  ...
  describe "update queue" do
    test "redirects when data is valid", %{conn: conn} do
      queue = BarserverTestLib.make_queue("update_redirect")
    ...
    test "renders errors when data is invalid", %{conn: conn} do
      queue = BarserverTestLib.make_queue("update_invalid")
  ...
  describe "delete queue" do
    test "deletes chosen queue", %{conn: conn} do
      queue = BarserverTestLib.make_queue("delete")
