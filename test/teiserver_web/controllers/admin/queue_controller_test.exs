defmodule TeiserverWeb.Admin.QueueControllerTest do
  ...
  describe "new queue" do
    test "renders form", %{conn: conn} do
      conn = get(conn, Routes.ts_admin_queue_path(conn, :new))
  ...
  describe "show queue" do
    ...
    test "renders show nil item", %{conn: conn} do
      assert_error_sent 404, fn ->
        get(conn, Routes.ts_admin_queue_path(conn, :show, -1))
      end
    end
  end
  ...
  describe "edit queue" do
    test "renders form for editing nil", %{conn: conn} do
      assert_error_sent 404, fn ->
        get(conn, Routes.ts_admin_queue_path(conn, :edit, -1))
      end
    end
  ...
  describe "update queue" do
    ...
    test "renders errors when nil object", %{conn: conn} do
      assert_error_sent 404, fn ->
        put(conn, Routes.ts_admin_queue_path(conn, :update, -1), queue: @invalid_attrs)
      end
    end
  end
  ...
  describe "delete queue" do
    ...
    test "renders error for deleting nil item", %{conn: conn} do
      assert_error_sent 404, fn ->
        delete(conn, Routes.ts_admin_queue_path(conn, :delete, -1))
      end
    end
  end
end
