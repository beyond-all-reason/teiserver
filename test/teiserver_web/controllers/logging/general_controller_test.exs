defmodule TeiserverWeb.Logging.LoggingControllerTest do
  ...
  test "lists admin links" do
    ...
    assert not (html_response(conn, 200) =~ ~p"/logging/live/dashboard"),
           "live dashboard not visible to admins"
  end
  ...
  test "lists server links" do
    ...
    assert html_response(conn, 200) =~ ~p"/logging/live/dashboard",
           "live dashboard is visible to servers admins"
  end
end
