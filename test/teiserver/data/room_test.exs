defmodule Teiserver.Data.RoomTest do
  ...
  test "clan limited rooms" do
    ...
    good_clan_user = User.update_user(%{good_clan_user | clan_id: 1})
    bad_clan_user = new_user("new_test_user_bad_clan_room")
    bad_clan_user = User.update_user(%{bad_clan_user | clan_id: 2})
    moderator_user = new_user("new_test_user_moderator_room")
    moderator_user = User.update_user(%{moderator_user | moderator: true})
