defmodule Teiserver.Battle.MatchMonitorTest do
  ...
  import Teiserver.TeiserverTestLib,
    only: [
      auth_setup: 0, _send_raw: 2, _recv_raw: 1, _recv_until: 1
    ]
  ...
  test "spring send" do
    ...
    assert result =~ "SAYPRIVATE AutohostMonitor endGameData eyJrZXkiOiJUaGlzIGlzIGEgdmVyeSBsb25nIHN0cmluZyIsInN1YiI6eyJrZXkiOiJ"
