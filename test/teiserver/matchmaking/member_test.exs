defmodule Teiserver.Matchmaking.MemberTest do
  ...
  describe "get_member_ratings" do
    ...
    test "rating for a user" do
      ...
      assert Member.get_member_rating([user.id], "Duel") == %{rating: 31, uncertainty: 3.5}
    end
    ...
    test "average of ratings" do
      ...
      assert Member.get_member_rating([u1.id, u2.id], "Duel") == %{rating: 40, uncertainty: 3}
    end
  end
