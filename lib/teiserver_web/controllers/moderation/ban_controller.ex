defmodule BarserverWeb.Moderation.BanController do
  ...
  def show(conn, %{"id" => id}) do
    ...
    |> assign(:user_stats, Barserver.Account.get_user_stat_data(ban.source_id))
    ...
    cond do
      ...
      true ->
        matching_users =
          ...
          |> Enum.reject(fn user ->
            Barserver.CacheUser.is_restricted?(user, ["Login"])
          end)
        ...
        hw_fingerprint =
          ...
          |> Barserver.Account.CalculateSmurfKeyTask.calculate_hw1_fingerprint()
  ...
  def create(conn, %{"ban" => ban_params}) do
    ...
    case Moderation.create_ban(ban_params) do
      {:ok, ban} ->
        ...
        Barserver.Moderation.RefreshUserRestrictionsTask.refresh_user(ban.source_id)
