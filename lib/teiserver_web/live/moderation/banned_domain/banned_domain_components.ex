defmodule TeiserverWeb.ModerationLive.BannedDomainComponents do
  @moduledoc false
  ...
  @doc """
  <TeiserverWeb.Moderation.BannedDomainComponents.search_form
    :if={assigns[:search]}
    params={@search}
  />
