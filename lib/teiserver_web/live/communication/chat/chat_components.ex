defmodule BarserverWeb.ChatComponents do
  @moduledoc false
  ...
  @doc """
  <BarserverWeb.ChatComponents.message_list messages={@messages} />
  """
  def message_list(assigns) do
    ...
    <div id="messages" phx-update="stream">
      ...
      <div
        ...
        id={dom_id}
        style={"background-color: #{Barserver.Helper.ColourHelper.rgba_css(message.user.colour, 0.08)}"}
      >
        <div
        ...
        >
          <%= Barserver.Helper.TimexHelper.date_to_str(message.inserted_at, format: :hms) %> &nbsp;
