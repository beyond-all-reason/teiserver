            ...
            <div class="me-3">
              <div class="input-group input-group-sm" style="width: 160px;">
                ...
                <button
                  ...
                  type="button"
                  onclick={"window.location.href='#{build_pagination_url(@base_url, @current_params, @include_params, %{"page" => "PAGE_PLACEHOLDER"}, ["page"])}'.replace('PAGE_PLACEHOLDER', document.getElementById('go-to-page-input').value)"}
                >
