defmodule Central.Communication.Post do
  ...
  def changeset(struct, params \\ %{}) do
    ...
    struct
    |> cast(params, [:title, :url_slug, :content, :short_content, :live_from, :allow_comments, :visible, :category_id, :poster_id, :tags])
    |> validate_required([:title, :url_slug, :content, :short_content, :allow_comments, :visible, :category_id, :poster_id, :tags])
  end
