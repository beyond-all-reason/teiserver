defmodule Central.CommunicationTestLib do
  ...
  def post_fixture(), do: new_post(%{"category_id" => new_category().id, "poster_id" => GeneralTestLib.make_user().id})
  ...
  def comment_fixture(), do: new_comment(%{"post_id" => post_fixture().id, "poster_id" => GeneralTestLib.make_user().id})
