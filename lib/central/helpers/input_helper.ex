defmodule Central.Helpers.InputHelper do
  ...
  @human_time_info {:safe, ["<button tabindex='-1' type='button' class='btn btn-sm btn-info float-right' data-toggle='popover' data-placement='left' title='Human time' data-content='Human time (HT) allows you to write more natural text and the system will convert it into a date for you. Examples include: \"this tuesday at 5pm\", \"next weekday\", \"30 minutes\" and most normal UK date formats.'>HT Enabled</button>"]}
  ...
  def input(form, field, opts \\ []) do
    ...
    choices = if is_function(opts[:choices]) do
