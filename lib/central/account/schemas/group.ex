defmodule Central.Account.Group do
  ...
  schema "account_groups" do
    ...
    many_to_many :members, Central.Account.User, join_through: "account_group_memberships",
  ...
  def changeset(struct, params \\ %{}) do
    ...
    struct
    |> cast(params, [:name, :icon, :colour, :data, :super_group_id, :see_group, :see_members, :invite_members, :self_add_members, :children_cache, :supers_cache, :active, :group_type])
    |> validate_required([:name, :icon, :colour, :data, :see_group, :see_members, :invite_members, :self_add_members])
  end
  def non_admin_changeset(struct, params \\ %{}) do
    ...
    struct
    |> cast(params, [:name, :icon, :colour, :data, :see_group, :see_members, :invite_members, :self_add_members, :children_cache, :supers_cache])
    |> validate_required([:name, :icon, :colour, :data, :see_group, :see_members, :invite_members, :self_add_members])
  end
