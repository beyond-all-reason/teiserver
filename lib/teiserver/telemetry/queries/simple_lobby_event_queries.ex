defmodule Barserver.Telemetry.SimpleLobbyEventQueries do
  @moduledoc false
  use BarserverWeb, :queries
  alias Barserver.Telemetry.SimpleLobbyEvent
  ...
  defp _preload(query, :event_types) do
    from simple_lobby_events in query,
      left_join: event_types in assoc(simple_lobby_events, :event_type),
  ...
  def get_aggregate_detail(event_type_id, start_datetime, end_datetime) do
    ...
    SELECT e.user_id, COUNT(e.id)
      FROM telemetry_simple_lobby_events e
