defmodule Barserver.Telemetry.SimpleLobbyEventTypeLib do
  @moduledoc false
  use BarserverWeb, :library_newform
  alias Barserver.Telemetry.{SimpleLobbyEventType, SimpleLobbyEventTypeQueries}
  ...
  def get_or_add_simple_lobby_event_type(name) do
    ...
    Barserver.cache_get_or_store(:telemetry_simple_lobby_event_types_cache, name, fn ->
      query =
  ...
  @spec create_simple_lobby_event_type(map) ::
          {:ok, SimpleLobbyEventType} | {:error, Ecto.Changeset}
  ...
  """
  @spec update_simple_lobby_event_type(SimpleLobbyEventType, map) ::
          {:ok, SimpleLobbyEventType} | {:error, Ecto.Changeset}
  ...
  """
  @spec delete_simple_lobby_event_type(SimpleLobbyEventType) ::
          {:ok, SimpleLobbyEventType} | {:error, Ecto.Changeset}
  ...
  def change_simple_lobby_event_type(
        %SimpleLobbyEventType{} = simple_lobby_event_type,
        attrs \\ %{}
      ) do
