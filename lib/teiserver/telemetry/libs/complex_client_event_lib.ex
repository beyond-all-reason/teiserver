defmodule Teiserver.Telemetry.ComplexClientEventLib do
  ...
  alias Teiserver.Telemetry.{ComplexClientEvent, ComplexAnonEvent, ComplexClientEventTypeLib}
  ...
  # Helpers
  @spec log_client_event(integer | nil, String, map()) :: {:error, Ecto.Changeset} | {:ok, ComplexClientEvent} | {:ok, ComplexAnonEvent}
  ...
  @spec log_client_event(integer | nil, String, map(), String | nil) :: {:error, Ecto.Changeset} | {:ok, ComplexClientEvent} | {:ok, ComplexAnonEvent}
  def log_client_event(nil, event_type_name, value, hash) do
    event_type_id = ComplexClientEventTypeLib.get_or_add_client_event_type(event_type_name)
