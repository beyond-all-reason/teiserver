defmodule Teiserver.Account.NewUserFunnelReport do
  ...
  def run(_conn, _params) do
    ...
    # Singleplayer
    event_type_ids = [
      Telemetry.ComplexClientEventTypeLib.get_or_add_client_event_type("game_start:singleplayer:lone_other_skirmish"),
      Telemetry.ComplexClientEventTypeLib.get_or_add_client_event_type("game_start:singleplayer:scenario_start")
    ]
    ...
    # Online
    event_type_ids = [
      Telemetry.ComplexClientEventTypeLib.get_or_add_client_event_type("game_start:multiplayer:connecting"),
      Telemetry.ComplexClientEventTypeLib.get_or_add_client_event_type("lobby:multiplayer:hostgame")
    ]
