defmodule Teiserver.TeiserverTestLib do
  ...
  def seed() do
    ...
    Teiserver.Telemetry.ComplexServerEventTypeLib.get_or_add_complex_server_event_type("Server startup")
    Teiserver.Telemetry.ComplexServerEventTypeLib.get_or_add_complex_server_event_type("account.user_login")
    Teiserver.Telemetry.ComplexClientEventTypeLib.get_or_add_client_event_type("account.user_login")
    Teiserver.Telemetry.ComplexClientEventTypeLib.get_or_add_client_event_type("client.user_event")
