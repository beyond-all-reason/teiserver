defmodule Teiserver.Protocols.Spring do
  ...
  # b11..b17 = handicap (7-bit number. Must be in range 0..100). Note: Only host can change handicap values of the
  #                                                                    players in the battle (with HANDICAP command).
  #                                                                    These 7 bits are always ignored in this command.
  #                                                                    They can only be changed using HANDICAP command.
