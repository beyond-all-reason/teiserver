defmodule Teiserver.Protocols.Tachyon.V1.LobbyOut do
  ...
  def do_reply(:update_values, {lobby_id, %{lobby_id: lobby_id, changes: new_values}}) do
    %{
      "cmd" => "s.lobby.update_values",
      "lobby_id" => lobby_id,
      "new_values" => new_values
  ...
  ###########
  # Modoptions
  def do_reply(:set_modoption, {lobby_id, msg}) do
    %{
  ...
  def do_reply(:set_modoptions, {lobby_id, msg}) do
    %{
      "cmd" => "s.lobby.set_modoptions",
      "lobby_id" => msg.lobby_id,
