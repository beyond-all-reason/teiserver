...
> friendsplay: allows only friends of existing players to become players (but anybody can join to spectate)",
      ...
      {"rename", ["new name"], "Renames the lobby to the name given. Requires boss privileges.",
       :everybody},
      {"resetratinglevels", [],
       "Resets the rating level limits to not exist. Player limiting commands are designed to be used with $rename, please be careful not to abuse them. Requires boss privileges.",
       :everybody},
