defmodule Teiserver.Game.AchievementCleanupTask do
  ...
  def brutal_to_normal_scenarios(from) do
    ...
    brutal_achievements = Game.list_user_achievements(search: [
      inserted_after: from,
    ...
    normals_to_add = brutal_achievements
