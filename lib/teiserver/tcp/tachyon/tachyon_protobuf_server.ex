defmodule Teiserver.TachyonProtobufServer do
  @moduledoc false
  use GenServer
  require Logger
  ...
  def start_link(_opts) do
    ...
    :ranch.start_listener(
      ...
      ssl_opts ++
        [
          {:port, Application.get_env(:central, Teiserver)[:ports][:tachyon_protobuf]}
        ],
      __MODULE__,
      []
    )
  ...
  def init(ref, socket, transport) do
    ...
    state = %{
      ...
      protocol_in: Application.get_env(:central, Teiserver)[:default_tachyon_protobuf_protocol].protocol_in(),
      protocol_out: Application.get_env(:central, Teiserver)[:default_tachyon_protobuf_protocol].protocol_out(),
