defmodule Teiserver.Repo.Migrations.CreateOauthTables do
  use Ecto.Migration
  ...
  def change do
    ...
    create table(:oauth_applications) do
      ...
      add :owner_id, references(:account_users, on_delete: :nothing)
    ...
    create table(:oauth_access_grants) do
      ...
      add :scopes, :string
      add :resource_owner_id, references(:account_users, on_delete: :nothing)
