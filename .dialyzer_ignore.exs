[
  ...
  {"lib/teiserver/account/reports/time_compare_report.ex", :no_return},
  {"lib/teiserver/account/reports/time_compare_report.ex", :unused_fun},
  ...
  {"lib/teiserver/battle/tasks/breakdown_match_data_task.ex", :invalid_contract},
  {"lib/teiserver/battle/tasks/post_match_process_task.ex", :invalid_contract},
  {"lib/teiserver/chat/room_server.ex", :contract_with_opaque},
  {"lib/teiserver/coordinator.ex", :invalid_contract},
  {"lib/teiserver/data/cache_user.ex", :invalid_contract},
  {"lib/teiserver/game/libs/match_rating_lib.ex", :invalid_contract},
  {"lib/teiserver/helpers/monitor_collection.ex", :contract_with_opaque},
  {"lib/teiserver/lobby/commands/explain_command.ex", :invalid_contract},
  {"lib/teiserver/lobby/libs/lobby_lib.ex", :invalid_contract},
  {"lib/teiserver/lobby/servers/lobby_server.ex", :invalid_contract},
  {"lib/teiserver/logging/tasks/aggregate_logs_task.ex", :invalid_contract},
  {"lib/teiserver/matchmaking/queue_server.ex", :contract_with_opaque},
  {"lib/teiserver/mix_tasks/fake_data.ex", :invalid_contract},
  {"lib/teiserver/mix_tasks/fake_data.ex", :call_without_opaque},
  {"lib/teiserver/mix_tasks/seasonal_uncertainty_reset_task.ex", :call_without_opaque},
  {"lib/teiserver/player/session.ex", :call_without_opaque},
  {"lib/teiserver/protocols/spring/spring_out.ex", :invalid_contract},
  {"lib/teiserver/tachyon_lobby/lobby.ex", :call_without_opaque},
  {"lib/teiserver/tcp/spring/spring_tcp_server.ex", :invalid_contract},
  {"lib/teiserver_web/controllers/account/general_controller.ex", :invalid_contract},
  ...
  {"lib/teiserver_web/controllers/telemetry/complex_client_event_controller.ex",
   :invalid_contract},
  {"lib/teiserver_web/controllers/telemetry/complex_lobby_event_controller.ex",
   :invalid_contract},
  {"lib/teiserver_web/controllers/telemetry/complex_match_event_controller.ex",
   :invalid_contract},
  {"lib/teiserver_web/controllers/telemetry/complex_server_event_controller.ex",
   :invalid_contract},
  {"lib/teiserver_web/controllers/telemetry/simple_client_event_controller.ex",
   :invalid_contract},
  {"lib/teiserver_web/controllers/telemetry/simple_lobby_event_controller.ex", :invalid_contract},
  {"lib/teiserver_web/controllers/telemetry/simple_match_event_controller.ex", :invalid_contract},
  {"lib/teiserver_web/controllers/telemetry/simple_server_event_controller.ex",
   :invalid_contract},

  # Wasn't able to get these to work with the exact warnings, whenever they were added dialyzer
  # said they were not used but if removed the errors flagged up
  {"lib/teiserver/game/libs/match_rating_lib.ex"},
  {"lib/teiserver/logging/tasks/persist_match_day_task.ex"},
  ~r/.*persist_match_day_task\.ex.*/,
  ~r/.*exact_compare/
]
